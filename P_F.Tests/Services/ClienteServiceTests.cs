namespace P_F.Tests.Services
{
    public class ClienteServiceTests
    {
        ...
        public async Task GetAllAsync_DeberiaRetornarTodosLosClientes()
        {
            ...
            _mockClienteRepo.Setup(r => r.GetAllWithIncludesAsync(
                It.IsAny<System.Linq.Expressions.Expression<Func<Cliente, bool>>>(),
            ...
            _mockClienteRepo.Verify(r => r.GetAllWithIncludesAsync(
                It.IsAny<System.Linq.Expressions.Expression<Func<Cliente, bool>>>(),
                It.IsAny<System.Linq.Expressions.Expression<Func<Cliente, object>>[]>()), 
                Times.Once);
        }
