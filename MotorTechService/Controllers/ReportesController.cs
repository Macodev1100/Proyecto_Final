...
{
    [Authorize(Policy = Policies.CanViewReportes)]
    public class ReportesController : Controller
    {
        ...
        public IActionResult ProductividadEmpleados(DateTime? fechaInicio, DateTime? fechaFin)
        {
            ...
            var empleadosProductividad = new List<MotorTechService.ViewModels.EmpleadoProductividad>();
            ...
            foreach (var empleado in empleados)
            {
                ...
                var minutosTrabajados = _context.Set<MotorTechService.Models.Entities.RegistroTiempo>()
                ...
                empleadosProductividad.Add(new MotorTechService.ViewModels.EmpleadoProductividad
                {
            ...
            var viewModel = new MotorTechService.ViewModels.ReporteProductividadViewModel
            {
