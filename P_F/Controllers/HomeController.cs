...
namespace P_F.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            var ordenesActivas = await _context.OrdenesTrabajo.CountAsync(o => o.Estado != P_F.Models.Entities.EstadoOrden.Completada && o.Estado != P_F.Models.Entities.EstadoOrden.Cancelada);
