...
builder.Services.AddScoped(typeof(P_F.Repositories.IRepository<>), typeof(P_F.Repositories.Repository<>));
builder.Services.AddScoped<P_F.Repositories.IClienteRepository, P_F.Repositories.ClienteRepository>();
builder.Services.AddScoped<P_F.Repositories.IVehiculoRepository, P_F.Repositories.VehiculoRepository>();
builder.Services.AddScoped<P_F.Repositories.IOrdenTrabajoRepository, P_F.Repositories.OrdenTrabajoRepository>();
builder.Services.AddScoped<P_F.Repositories.IEmpleadoRepository, P_F.Repositories.EmpleadoRepository>();
builder.Services.AddScoped<P_F.Repositories.IFacturaRepository, P_F.Repositories.FacturaRepository>();
builder.Services.AddScoped<P_F.Repositories.IRepuestoRepository, P_F.Repositories.RepuestoRepository>();
builder.Services.AddScoped<P_F.Repositories.IServicioRepository, P_F.Repositories.ServicioRepository>();
